...
Hi, Hank's here. This video is sharing how to use Kotlin Coroutines on Android. Kotlin Coroutines are a new way to manage asynchronous tasks on Android. It simplify the code through reducing the usage of callbacks.
